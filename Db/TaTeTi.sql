...
CREATE TABLE `Idiomas` (
  ...
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de idiomas';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Resultados_partidas` (
  `idresultado_partida` int(11) NOT NULL AUTO_INCREMENT,
  `final_partida` datetime(6) NOT NULL,
  `comienzo_partida` datetime(6) NOT NULL,
  `Jugador_NOMBRE` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `ganador` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
-- Dump completed on 2022-11-19 12:03:53
